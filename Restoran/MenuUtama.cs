...
namespace Restoran
{
    public partial class MenuUtama : Form
    {
        ...
        private void lbl_menu1_Click(object sender, EventArgs e)
        {

        }

        private void pcb_menu0_Click(object sender, EventArgs e)
        {

        }

        private void pcb_menu4_Click(object sender, EventArgs e)
        {
